...
const GOOGLE_CLIENT_ID = "441996266094-qgab7v5q4cgk2nlh06jhbf5g4si1dd80.apps.googleusercontent.com";
...
const SignUpPage = () => {
  ...
  const { signup, googleAuth, isSigningUp } = useAuthStore();
  ...
  const handleGoogleSignUp = () => {
    ...
    window.google.accounts.id.prompt((notification) => {
      if (notification.isNotDisplayed() || notification.isSkippedMoment()) {
        // Fallback: render a temporary button if One Tap doesn't show
        const buttonDiv = document.createElement("div");
        buttonDiv.id = "google-signup-fallback";
        buttonDiv.style.position = "fixed";
        buttonDiv.style.top = "50%";
        buttonDiv.style.left = "50%";
        buttonDiv.style.transform = "translate(-50%, -50%)";
        buttonDiv.style.zIndex = "9999";
        buttonDiv.style.background = "rgba(0,0,0,0.7)";
